    ...
    function FollowCard({ viewerId = "", userId = "", setOpenFollowModal, setActiveFollow, activeFollow }) {
        ...
        return (
            <div className='fixed bg-[#303030] p-5 rounded-lg flex flex-col gap-3 w-[calc(100vw-5%)] lg:w-[calc(100vw-20%)] h-[calc(100vh-150px)] transition-all ease-in-out duration-200'>
                <div className='flex'>
                    ...
                    <h1 className={`font-bold ${activeFollow == "Followers" ? `underline` :  `decoration-[#808080]`} underline-offset-3 hover:underline ease-in-out duration-200`} onClick={() => setActiveFollow("Followers")}>Followers</h1>
                    <p className='text-[#808080]'>|</p>
                    <h1 className={`font-bold ${activeFollow == "Following" ? `underline` :  `decoration-[#808080]`} underline-offset-3 hover:underline ease-in-out duration-200`} onClick={() => setActiveFollow("Following")}>Following</h1>
                </div>
                <Plus className='size-5 rotate-45 hover:rotate-135 duration-200 ease-in-out' onClick={() => setOpenFollowModal(false)}/>
                </div>
                <div className='flex flex-col gap-1'>
                    {
                        (activeFollow === "Followers" ? followers : following).map((f, index) => (
