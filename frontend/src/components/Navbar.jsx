    ...
    <div className="fixed w-full z-50">
        <div className="flex justify-between md:px-20 px-5 mt-2 mb-2 z-10">
            <div className="flex gap-2 items-center">
                <img src="/cinescope.png" className="size-10 rounded-full shadow-2xl"></img>
                <p className="font-bold text-2xl md:text-3xl shadow-2xl">CineScope</p>
            </div>
            <div className="border rounded-full md:flex p-1 gap-2 items-center pr-2 hidden  shadow-2xl">
            ...
            <div className="md:flex gap-5 font-light items-center text-[14px] hidden">
                ...
                <img src="/user.png" className="size-9 shadow-2xl" onClick={() => setProfileIsOpen(!profileIsOpen)}></img>
            </div>
