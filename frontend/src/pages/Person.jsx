...
function Person() {
    ...
    return (
        <>
            <Helmet>
                <title>{`${person?.name || "Person"} | Shotlist`}</title>
                <meta
                    name="description"
                    content={person?.biography?.slice(0, 160)}
                />
                <meta
                    property="og:title"
                    content={`${person?.name} | Shotlist`}
                />
                <meta
                ...
                <meta
                    property="og:image"
                    content={`https://image.tmdb.org/t/p/w780${person?.profile_path}`}
                />
                <meta
                    property="og:type"
                    content="profile"
