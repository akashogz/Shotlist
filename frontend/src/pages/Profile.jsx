...
import { Bookmark, Check, MessageSquareMore, Star } from 'lucide-react';
...
function Profile() {
    ...
    return (
        <div className='p-20 h-full w-screen flex items-center flex-col gap-2 justify-between'>
            <img src={`https://api.dicebear.com/9.x/thumbs/svg?seed=${user.avatarSeed}`} className='size-18 rounded-full border-3' />
            <div className='flex flex-col items-center gap-5'>
                ...
                <div className='grid grid-cols-4 max-w-3xl gap-2 bg-[#303030] rounded-lg text-sm shadow-xl'>
                    <div className='border-r p-4 border-[#3D3D3D] flex gap-2 items-center justify-center'>
                    ...
                    <div className='border-r p-4 border-[#3D3D3D] flex gap-4 items-center justify-center'>
                        <div className='flex gap-2 items-center'>
                    ...
                    <div className='p-4 border-[#3D3D3D] flex gap-2 items-center justify-center'>
                        <div className='flex gap-2 items-center'>
            ...
            <div className='w-full items-center justify-between pt-3'>
                <div className='w-full grid grid-cols-4 text-center'>
                    ...
                    <p className={`cursor-pointer border-r border-white/50 p-2  font-bold ${active.label == "Reviews" ? `underline underline-offset-4` : ` hover:underline hover:decoration-white/50 hover:underline-offset-4`}`} onClick={() => setActive(tabs[1])}>Reviews</p>
