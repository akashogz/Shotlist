...
import MoreModal from "@/components/features/MoreModal";
...
function Info({
    ...
    const isTrailerOpen = searchParams.get("trailer");
    ...
    useEffect(() => {
        ...
        const fetchAll = async () => {
            try {
                ...
                setIsWatchlisted(watchedRes.data.isWatchlisted);
                        ...
                        <div className="lg:col-span-2">
                            ...
                            <div className="flex gap-4 overflow-x-auto pb-4 no-scrollbar">
                                {movie.credits?.cast?.slice(0, 10).map(actor => (
                                    <div key={actor.id} className="shrink-0 w-28 md:w-32" onClick={() => router.push(`/person/${actor.id}`)}>
                                        {
                                            actor.profile_path ?
                                                <img
                        ...
                        <section className="mt-10">
                            ...
                            {loggedIn ? (
                                ...
                                <div className="bg-white/5 p-6 rounded-xl text-center text-sm">
                                    <p>Please <Link href="/login" className="text-[#464E82] underline font-bold">Login</Link> to share your thoughts.</p>
                                </div>
                            )}
                        </section>
                    )
